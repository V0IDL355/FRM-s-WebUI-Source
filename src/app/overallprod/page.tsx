...
const chartConfig = {
    prodpermin: {
        label: "Production Per Min", color: "#ca9ee6",
    }, conspercent: {
        label: "Consumed Percent", color: "#e78284",
    }, currentprod: {
        label: "Current Production", color: "#ef9f76",
    }, maxprod: {
        label: "Max Production", color: "#e5c890",
    }, currentconsumed: {
        label: "Current Consumed", color: "#a6d189",
    }, maxconsumed: {
        label: "Max Consumed", color: "#81c8be",
    },
